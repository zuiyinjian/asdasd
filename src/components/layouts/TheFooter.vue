    ...
    <div class="container">
		<div class="row footer-top">
			<div class="col-sm-5 col-lg-5">
				...
				<div class="text-md">
					<a v-for="item in contacts" :key="item.icon" v-title="item.title" :href="item.link" :style="contactStyle" target="_blank">
			...
			<div class="col-sm-6 col-lg-6 col-lg-offset-1">
				<div class="row">
					...
					<div class="col-sm-4">
						...
						<ul class="list-unstyled">
							<li v-for="item in statistics.list" :key="item.title">
					...
					<div class="col-sm-4">
						<h4>{{ other.title }}</h4>
						<ul class="list-unstyled">
							<li v-for="item in other.list" :key="item.icon">
    ...
    return {
      ...
      designer: `
        <span style="font-size:0.9em">Designed by
          ...
          <a href="https://github.com/zuiyinjian"target="_blank"style="color:inherit">老宋</a>
        </span>
      `,
      sponsor: {
        title: '赞助商',
